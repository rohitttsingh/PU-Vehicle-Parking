...
public class SearchActivity extends AppCompatActivity {
    ...
    Button callOne,callTwo, messageOne, messaageTwo ,emailbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messaageTwo = findViewById(R.id.messageTwo);
        ...
        String vehicleNo= mResultEt.getText().toString();
            ...
            emailbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    sendEmail(tvname.getText().toString(),tvemail.getText().toString(),mResultEt.getText().toString());
                }
            });
        ...
        ColorDrawable colorDrawable = new ColorDrawable(Color.parseColor("#2966a3"));
        actionBar.setBackgroundDrawable(colorDrawable);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        actionBar.setSubtitle("Search the information");

        messageOne.setEnabled(true);
        if (checkPermission(Manifest.permission.SEND_SMS ))
        {
            ...
            ActivityCompat.requestPermissions(SearchActivity.this,new String[] {Manifest.permission.SEND_SMS}
        ...
        messageOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                phoneNo = tvphone1.getText().toString();
                message = "This message is from the PU security, "  +
                        "\nYour Vehicle with Number: "+ mResultEt.getText().toString()+tvname.getText().toString() +" is in wrong parking. You can contact to the Admin at 9328666909" ;

                sendSMSMessage(phoneNo,message);

            }
        });
        messaageTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                phoneNo = tvphone2.getText().toString();
                message = "This message is from the PU security, "  +
                        "\nYour Vehicle with Number: "+ mResultEt.getText().toString()+tvname.getText().toString() +" is in wrong parking. You can contact to the Admin at 9328666909" ;
    ...
    protected void sendEmail(String name, String email, String vNumber) {
        Log.i("Send email", "");
       ...
       // String message =
        ...
        emailIntent.setData(Uri.parse("mailto:rohitsingh270701@gmail.com"));
        emailIntent.setType("text/plain");
        emailIntent.putExtra(Intent.EXTRA_EMAIL, TO);
        emailIntent.putExtra(Intent.EXTRA_CC, CC);
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Wrong Parking of vehicle");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "This message is from the PU security, " +
                "\nYour Vehicle with Number: "+ vNumber +" "+name +
                " is in wrong parking. You can contact to the Admin at 9328666909");
        ...
        try {
            ...
            Toast.makeText(SearchActivity.this, "There is no email client installed.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public  boolean checkPermission(String permission){
        int check = ContextCompat.checkSelfPermission(SearchActivity.this,permission);
